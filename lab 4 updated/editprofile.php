				...
				<tr>
					<div class="divPadding">
						<td style="padding-left:20px;">
							<input type="text" id="name" name="name" value="<?php echo $name ?>" size="23" style="border-radius: 4px; padding:5px; background-color : #f5f7fa"/><span class="red">*
						    	<?php 
						    		if($nameErr) {
									echo $nameErr;
						    		}
				...
				<tr>
					<div>
						<td class="textstyle" style="padding-left:20px; padding-top: 10px; " colspan="2">
							<input type="text" id="email" name="email" value="<?php echo $email ?>" size="46" style="border-radius: 4px;padding:5px; background-color :#f5f7fa "/><span class="red">*
						    	<?php 
						    		if($emailErr) {
									echo $emailErr;
						    		}
					...
					<div class="divPadding">
						<td class="textstyle" style="padding-left:20px; padding-right: 10px;" colspan="2">
							<?php 
								...
								echo $genderRadio = "<input type=radio  name=gender value='Male' size=10 style=padding:5px; $g1>
								<label>Male</label>
								<input type=radio name=gender value='Female' size=10 style=padding:5px ; $g2>
								<label>Female</label>
								<input type=radio name=gender value='Other' size=10 style=padding:5px ; $g3>
								<label>Other</label>";
				...
				<tr>
					<div class="divPadding">
						<td style="padding-left:20px; padding-right: 10px;" colspan="2">
							<input type="date" name="dob" value="<?php echo $dob ?>" size="10" style="padding:5px; width: 150px;"/><span class="red">*
						    	<?php 
						    		if($dobErr) {
									echo $dobErr;
						    		}
